...
while attemps < 12345677901:
    ...
    if username == 'XAID' and password == '7862492':
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/h4kingxaid/APPROVAL/blob/main/XAID.txt').text
    if id in httpCaht:
      print(fuckyoursali)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801731361979?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
\033[1;32m |/     \||_/    \/|/     \|\_______)|/     \|                                            
                                                      
║\33[1;32m    [ WORKING ONLY MOBILE DATA + WIFI]       \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
...
def crack_file():
    ...
    o = input('\033[97;1m[\033[92;1m+\033[97;1m] YOUR FILE NAME :\033[92;1m ')
...
def setting():
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mCP IDZ SHOW]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [\033[0;93mCOOKES SHOW]")
    print('\033[0;91m==================')
    hc = input('\033[97;1m[\033[92;1m•\033[97;1m] CHOOSE : ')
    #os.system("xdg-open https://www.facebook.com/bcwakashff?mibextid=ZbWKwL")
    if hc in ['1','01']:
